...
def main():
	...
	pFunction = r['topScoringIntent']['intent']
	pProduct = r['entities'][0]['entity']
	

	if (pFunction == "Price"):
		sayThis = ncr.searchItem(pProduct)
		system('say ' + sayThis)
	elif (pFunction == "Cheapest Price"):
		sayThis = ncr.cheapestItem(pProduct)
		system('say ' + sayThis)
